...
class CustomFileField(models.FileField):
    ...
    def __init__(self, *args, storage_category, **kwargs):
        """
        Initialize the CustomFileField with dynamic S3 credentials and configuration.
        """
    ...
    def deconstruct(self):
        ...
        # Explicitly include storage_category in the serialized form
        kwargs["storage_category"] = self.storage_category
        return name, path, args, kwargs

    def get_storage(self, model_instance):
        """
        Create and return a dynamic S3 storage instance.
        """
        return CustomS3Boto3Storage(
            workspace_id=model_instance.workspace_id,
            storage_category=self.storage_category,
        )

    def pre_save(self, model_instance, add):
        """
        Dynamically assign storage to the field before saving the file.
        """
