...
class ProjectViewSetTestCases(TestCase):
    ...
    def setUp(self):
        ...
        PUB_KEY = "ssh-rsa "
        ...
        self.dbtcore_details = DBTCoreDetails.objects.create(
            resource=bigquery_resource,
    ...
    def test_create_file(self):
        filepath = "models/marts/sales.sql"
        encoded_filepath = safe_encode(filepath)
