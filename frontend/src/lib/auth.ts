...
const api = wretch(process.env.NODE_ENV === "development" ? (process.env.API_URL ?  process.env.API_URL : "http://localhost:8000") : process.env.NEXT_PUBLIC_BACKEND_HOST).accept("application/json");
