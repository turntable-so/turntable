...
import FullWidthPageLayout from "../layout/FullWidthPageLayout";

import { Button } from "@/components/ui/button";
import Link from "next/link";
import { getPaginatedJobs, getPaginatedRuns } from "@/app/actions/actions";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import JobsList from "@/components/jobs/jobs-list";
import RunsList from "@/components/jobs/runs-list";

export default async function JobsAndRunsPage() {
  const runsPromise = getPaginatedRuns();
  const jobsPromise = getPaginatedJobs();
