...
const ColumnLineageFlow = () => {
    ...
    const columnLineage: any = useMemo(() => {
        if (lineage) {
            return getColumnLineageForAsset({ assetId: lineage.asset_id, links: lineage.asset_links, nodes: lineage.assets, columnLinks: lineage.column_links });
        }
        return null;
    }, [lineage]);
    ...
    return (
        ...
        >
            ...
            {
                isLineageLoading && (
                    <Panel className='flex flex-col w-full h-full items-center justify-center' position="top-left">
                        <div>
