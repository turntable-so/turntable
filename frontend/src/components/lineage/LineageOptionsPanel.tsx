...
export default function LineageOptions() {
    ...
    const { rootAsset, lineageOptions, setIsLineageOptionsPanelOpen, isLineageOptionsPanelOpen, setLineageOptionsAndRefetch } = useContext(LineageViewContext)
    ...
    return (
        <Panel position="top-left">
            {isLineageOptionsPanelOpen ? (
                <div onClick={() => setIsLineageOptionsPanelOpen(true)} className='px-3 p-2 text-sm font-medium text-muted-foreground border-2 border-gray-300 bg-white rounded-md'>
                    <div className='flex space-x-2 text-muted-foreground items-center'>
                        <div className='flex flex-col items-center space-y-1'>
                            <Button onClick={() => incrementPredecessorDepth(1)} variant='secondary' className='p-0 h-5 opacity-70 hover:opacity-100'>
                        ...
                        <div className='flex flex-col items-center space-y-1'>
                            <Button onClick={() => incrementSuccessorDepth(1)} variant='secondary' className='p-0 h-5 opacity-70 hover:opacity-100'>
                                <Plus className='size-4' />
                            </Button>
                            <div className='py-0.5'>
                ...
                <div onClick={() => setIsLineageOptionsPanelOpen(true)} className=' cursor-pointer opacity-70 hover:opacity-100 px-3 p-2 text-sm font-medium text-muted-foreground border-2 border-gray-300 bg-white rounded-md'>
