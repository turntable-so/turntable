...
const DbtCoreConfig = ({ resources, form }: { resources: any[], form: any }) => (
    ...
    return (
        <div className='w-full max-w-2xl'>
            {(!resources || resources.length === 0) ? (
                ...
                <Tabs defaultValue="remote" onValueChange={(value) => setSelectedTab(value as 'remote' | 'local')}>
                    <TabsList>
                    ...
                    <TabsContent value="remote">
                        <Form {...remoteForm}>
                            <form onSubmit={remoteForm.handleSubmit(onSubmit)} className="space-y-6 text-black">
                                <Card className="w-full rounded-sm">
                                    <CardHeader>
                                        <CardTitle className="text-xl">
                                            Code Repository
                    ...
                    <TabsContent value="local">
                        <Form {...localForm}>
                            <form onSubmit={localForm.handleSubmit(onSubmit)} className="space-y-6 text-black">
                                <Card className="w-full rounded-sm">
                                    <CardHeader>
                                        <CardTitle className="text-xl">
                                            Local Directory
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <CardDescription>Note: If using Docker, Make sure this path is mounted as a volume in the container. This should be the full path where there is a dbt_project.yaml at the root.</CardDescription>
                                                    <FormControl>
                                                        <Input placeholder="Directory of your repository that contains your dbt project" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
