...
export default function TableauForm({ resource, details }: { resource?: any, details?: any }) {
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="https://acme.online.tableau.com" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Required for Tableau Online. Leave blank to connect to default site on Tableau Server
                                        </FormDescription>
                                        <FormControl>
