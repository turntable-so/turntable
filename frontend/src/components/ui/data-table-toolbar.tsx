        ...
        {table
          ...
          .map((column) => {
            return (
              ...
              >
                {/* TODO: Implement a better way to have "friendly names" for the dropdown options */}
                ...
                {table.getColumn("resource") && assets?.filters?.sources && (
                  <DataTableFacetedFilter
                    ...
                    options={assets.filters.sources.map((resource: any) => ({
                      label: assets.resources.find(
                        (r: any) => r.id === resource.resource__id,
                      )?.name,
