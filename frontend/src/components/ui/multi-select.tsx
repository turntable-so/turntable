...
export default function MultiSelect({ items, selected, setSelected, label, functionSelected = null }: { items: Item[], selected: Item[], setSelected: any, label: string, functionSelected: any }) {
