...
const AppContent = () => {
    ...
    return (
        ...
        >
            <div className={`flex h-[52px] w-[${appSidebarCollapsed ? '64px' : '250px'}] border-r border-gray-300  hover:bg-white hover:cursor-pointer`}>
    ...
    return (
        ...
        >
            <div className="flex justify-center">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="ghost" className='hover:bg-white' size="icon" onClick={() => router.push('/projects')}>
