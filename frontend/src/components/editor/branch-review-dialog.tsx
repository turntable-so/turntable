                                ...
                                <div className='mt-4'>
                                    ...
                                    <div className='gap-1 flex flex-col overflow-y-scroll max-h-[300px]'>
                                        {(changes || []).map((change: any, index: number) => (
                                            <div className={`truncate text-xs flex justify-between py-0.5 hover:bg-muted rounded-md hover:cursor-pointer ${selectedChangeIndex === index ? "bg-muted" : ""}`} key={index}>
