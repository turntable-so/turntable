...
import {
  slashCommand,
  suggestionItems,
} from "../../../components/notebook/slash-command";
...
export default function Page() {
  ...
  const params = useParams();
  const { isFullScreen, fullScreenData, setFullScreenData, setIsFullScreen } =
    useAppContext();
  const notebookId = params.id as string;
    ...
    <Fragment>
        ...
        <div className="flex flex-col h-full items-center">
          <div className="px-20 py-12 w-full">
            ...
            <div className="my-8 flex flex-wrap">
              <input
                className="w-full border-none focus:outline-none scroll-m-20 text-4xl font-bold tracking-tight text-gray-800"
                value={title}
      ...
      {isFullScreen && (
        <FullScreenDialog isOpen={isFullScreen} onOpenChange={setIsDialogOpen}>
          <Button variant="ghost" onClick={closeFullScreen}>
            X
          </Button>
